/*
  ...
  - The values [MANUAL_TRIGGER,HTTP_REQUEST,GOOGLE_FORM_TRIGGER,STRIPE_TRIGGER,ANTHROPIC,GEMINI,OPENAI,DISCORD,SLACK] on the enum `NodeType` will be removed. If these variants are still used in the database, this will fail.
